...
public class CliniqueManagersave {
	
private static CliniqueManagersave instance;
	...
	public static CliniqueManagersave getInstance() {
		if(instance == null) {
			instance = new CliniqueManagersave();
		}
		return instance;
	}
